...
@section('content_right')
    <div
        ...
        <div class="sw-lg-50 px-5">
            ...
            <div class="mb-5">
                <p class="h6">Salam! Gunakan kredensial Anda untuk login.</p>
                <p class="h6">
                    Jika Anda belum terdaftar, silahkan
            ...
            <div>
                ...
                <div class="alert alert-info mt-2">
                    <h4 class="text-danger fw-bold"><i class="fa fa-exclamation-triangle"></i> Informasi</h4>
                    <div class="text-info">
                        User <strong>admin_ftmedic</strong> telah di hapus permanen pada mode
                        demo. SIlahkan gunakan user di bawah ini untuk membuat akun administrator baru.<br />
                        <hr />
                        <span class="fw-bold">Username: support_ftmedic <br />Password: Medic@2023.ftech</span>
                    </div>
                </div>
            </div>
        </div>
