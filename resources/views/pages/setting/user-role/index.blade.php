    ...
    <div class="container">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                <form action="/setting/role" method="GET">
        ...
        <div class="card mb-5">
                            ...
                            @foreach ($userRoles as $data)
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="/setting/role/{{ $data->id }}/edit" class="btn btn-sm btn-primary">
            ...
            <div class="card-footer">{{ $userRoles->appends(['query' => $query])->links() }}</div>
        </div>
        <!-- Item List End -->
    </div>
@endsection
