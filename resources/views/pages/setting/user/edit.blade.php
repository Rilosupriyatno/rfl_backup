...
@section('content')
    <div class="container">
        ...
        <!-- Form Start -->
        <form method="POST" action="/setting/user/update" class="card mb-5 tooltip-end-top">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row g-3 mb-3">
                    <div class="col-6 col-sm-6 col-xl-6">
                        <div class="w-100">
                            ...
                            <input class="form-control" autocomplete="off" name="name" value="{{ $user->name }}">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-6">
                        <div class="w-100">
                            ...
                            <select class="form-control" autocomplete="off" id="user_role_id" name="user_role_id">
                                <option value="{{ $user->user_role_id }}" selected>
                                    {{ $user->userRoles->description }}
                                </option>
                            </select>
                        </div>
                    </div>
