...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //     $table->unsignedBigInteger('change')->default(0)->change();
        //     $table->unsignedBigInteger('grandtotal')->default(0)->change();
        // });
    }
    ...
    public function down(): void
    {
        ...
        //     $table->unsignedFloat('change')->default(0)->change();
        //     $table->unsignedFloat('grandtotal')->default(0)->change();
        // });
    }
};
