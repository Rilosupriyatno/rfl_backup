...
class Scripts {
    ...
    _initSettings() {
        if (typeof Settings !== 'undefined') {
            const settings = new Settings({ attributes: { placement: 'vertical', layout: 'boxed', color: 'light-green', radius: 'standard' }, showSettings: false, storagePrefix: 'fathtech-medical-app-' });
        }
    }
